...
GRANT EXECUTE ON sys.EXPORTFILE TO pdb_kurs_app_admin;
...
/
--alter table app_users MODIFY id integer generated BY DEFAULT as identity ;
--select * from all_constraints where table_name = 'APP_USERS';
/
...
/
alter table BubbleChart modify id integer generated BY DEFAULT  as identity;
...
/
alter table barchart modify id integer generated BY DEFAULT  as identity;
...
alter table LineChart modify id integer generated BY DEFAULT  as identity;
/
